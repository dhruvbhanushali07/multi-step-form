    ...
    <div className="relative h-4/5 w-full lg:h-full">
      ...
      <h1 className="text-2xl lg:text-4xl font-bold text-primary-marine-blue">
        ...
        <div className="flex flex-col gap-2">
          {!isOn?monthlyPlan.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                />
                <label className=" w-full flex gap-4" htmlFor={item.plan}>
                  <div className="planicon">
                    <img src={planslogo[index]} alt="logo" />
                  </div>
                  <div>
                  <h1 className="text-primary-marine-blue font-medium">{item.plan}</h1>
            ...
            return (
              ...
              >
                <input
                  ...
                  onChange={(e) => setcurrentPlan(e.target.value)}
                />
                <label className=" w-full flex flex-wrap content-center gap-4 " htmlFor={item.plan}>
                  <div className="planicon">
                    <img src={planslogo[index]} alt="logo" />
                  </div>
                  <div>
                    <h1 className="text-primary-marine-blue font-medium">{item.plan}</h1>
                    <h2 className="text-neutral-cool-gray">{item.price}</h2>
                    <h2 className="text-primary-marine-blue">2 months free</h2>
                  </div>
                </label>
              </div>
            );
        ...
        <div className="w-full bg-neutral-magnolia p-2 rounded-md flex flex-wrap content-center justify-center gap-4">
          <h1 className={`${!isOn?"text-primary-marine-blue font-medium":"text-neutral-cool-gray"}`}>Monthly</h1>
          <div>
            <div
          ...
          <h1 className={`${isOn?"text-primary-marine-blue font-medium":"text-neutral-cool-gray"}`}>Yearly</h1>
        </div>
      </div>
